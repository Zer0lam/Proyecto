 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://pkgNuevows/", wsdlLocation = "http://localhost:8080/WSZero/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://pkgNuevows/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WSZero/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://pkgNuevows/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pkgNuevows/", "NewWebServicePort"), NewWebService.class, features);
    }
